(function (L, ExifReader) {
    'use strict';

    function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

    var L__default = /*#__PURE__*/_interopDefaultLegacy(L);
    var ExifReader__default = /*#__PURE__*/_interopDefaultLegacy(ExifReader);

    L__default["default"].Map.addInitHook(function() {
      this.getContainer()._leaflet_map = this;
    });
    let markerIcon = L__default["default"].icon({
    ...
    let Exif = function() {
      ...
      Exif2.prototype.getExif = function(event) {
        ...
        if (useData) {
          ...
          this.exif = ExifReader__default["default"].load(thumbnail.src);
        ...
        this.core.LGel.on(lGEvents.beforeSlide + ".exif", function(event) {
          ...
          _this.exif.then(function(exif) {
            ...
            if (typeof exif.GPSLatitude !== "undefined" && typeof exif.GPSLatitude.description !== "undefined" && typeof exif.GPSLongitude !== "undefined" && typeof exif.GPSLongitude.description !== "undefined") {
              map = L__default["default"].map("map").setView([exif.GPSLatitude.description, exif.GPSLongitude.description], 13);
              L__default["default"].tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
                maxZoom: 19,
                attribution: "\xA9 OpenStreetMap"
              }).addTo(map);
              L__default["default"].marker([exif.GPSLatitude.description, exif.GPSLongitude.description], { icon: markerIcon }).addTo(map);
            }
          });
        });
