...
let exifSettings = {
    exifMarkup:
        '<div id="lg-exif-box" class="lg-exif-box lg-fb-exif-box"><div class="lg-exif-header"><h3 class="lg-exif-title">Image Information</h3><span class="lg-exif-close lg-icon"></span></div><div class="lg-exif-body"></div></div>',
    exifPluginStrings: {
...
let Exif = /** @class */ (function () {
    function Exif(instance, $LG) {
    ...
    Exif.prototype.appendData = function (exif, value, label, prefix, suffix) {
        ...
        if (exifEl) {
            ...
            if (typeof exifEl === "string" && exifEl.startsWith(prefix)) prefix = "";
            if (typeof exifEl === "string" && exifEl.endsWith(suffix)) suffix = "";
            ...
            if (value === "ExposureTime" && exifEl.description) {
                ...
                data = exifEl.description ?? exifEl.value[0];
            }
    ...
    Exif.prototype.formatExifDetails = function (exif) {
        let html = "<ul>";
    ...
    Exif.prototype.setMarkup = function () {
        this.core.outer.append(this.settings.exifMarkup + '<div class="lg-exif-overlay"></div>');
        let exifToggleBtn =
            '<button type="button" aria-label="' +
            this.settings.exifPluginStrings["toggleexifs"] +
            '" class="lg-exif-toggle lg-icon lg-info"></button>';
        this.core.$toolbar.append(exifToggleBtn);
    };

    Exif.prototype.toggleExifPanel = function () {
        let _this_1 = this;
        this.core.outer
            .find(".lg-exif-toggle")
            .first()
            .on("click.lg.exif", function () {
                _this_1.core.outer.toggleClass("lg-exif-active");
            });
        this.core.outer
            .find(".lg-exif-overlay")
            .first()
            .on("click.lg.exif", function () {
    ...
    Exif.prototype.getExif = function (event) {
        let _this = this;
        ...
        if (useData) {
            this.exif = new Promise((resolve, reject) => {
                resolve({
                    ...
                    // SourceResolution: { description: thumbnail.dataset.sourceresolution },
            ...
            this.exif.then(function (exif) {
                _this.exif = exif;
                _this.exif.Filename = { description: thumbnail.dataset.imgFilename ?? thumbnail.src.replace(/^.*[\\\/]/, "") };
            });
        }
    };
    ...
    Exif.prototype.init = function () {
        ...
        this.core.LGel.on(lGEvents.beforeSlide + ".exif", function (event) {
            ...
            _this.exif
                ...
                .then(function (exif) {
                    if (
                        typeof exif.GPSLatitude !== "undefined" &&
                        typeof exif.GPSLatitude.description !== "undefined" &&
                        typeof exif.GPSLongitude !== "undefined" &&
                        typeof exif.GPSLongitude.description !== "undefined"
                    ) {
